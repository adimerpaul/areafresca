...
let processingBarcode=false,clientSearchTimer=null
...
function handleSearchInput(value){if(parseScaleBarcode(value))addExact();else resetProductsPage()}
